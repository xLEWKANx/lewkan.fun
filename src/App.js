		...
		<Background>
			...
			<FusionContainer>
				...
				<Text>
					...
					за подробностями{" "}
					<Link target="_blank" href="https://t.me/xlwknx">мне в телеграмме</Link>. Денег за
					вход не прошу, но буду рад подарку или free donation в фонд развития
					сильных движух. Для того, чтобы попасть на вечеринку, нужно обязательно быть{" "}
					<Link target="_blank" href="https://t.me/joinchat/AAAAAFBg41eVsQUQAR6JrQ">
						в канале
					</Link>
